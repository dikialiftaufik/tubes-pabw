    ...
    <div class="container-fluid px-4 px-lg-5 position-relative">
        ...
        <div class="collapse navbar-collapse w-100" id="navbarContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item"><a class="nav-link {{ request()->routeIs('menu.index') ? 'active' : '' }}"
                        href="{{ route('menu.index') }}">Menu</a></li>
                <li class="nav-item"><a class="nav-link" href="#reservation">Reservasi</a></li>
            </ul>

            {{-- CENTER --}}
            <a class="navbar-brand navbar-brand-center d-none d-lg-block position-absolute start-50 translate-middle-x"
                href="{{ url('/') }}">
                THE KOMAR'S
            </a>
            ...
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0 align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('riwayat.pesanan') ? 'active' : '' }}"
                        href="{{ route('riwayat.pesanan') }}">Riwayat</a>
                </li>
                ...
                @else
                    <li class="nav-item ms-2">
                        <a class="nav-link btn btn-outline-light rounded-pill px-3 py-1 text-white"
