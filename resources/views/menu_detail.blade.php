        ...
        <div class="card shadow border-0 rounded-4 overflow-hidden">
            <div class="row g-0">
                <div class="col-lg-6 bg-light d-flex align-items-center justify-content-center position-relative">
                    @if($menu->foto)
                        <img src="{{ asset('img/menu/' . $menu->foto) }}" class="img-fluid w-100 h-100"
                            style="object-fit: cover; min-height: 400px; max-height: 550px;" alt="{{ $menu->nama }}">
                    @else
                        ...
                        <div class="row g-3 mb-4">
                            <div class="col-6">
                                <div class="d-flex align-items-start p-3 rounded-3 bg-light border border-light h-100">
                                    ...
                                    <div>
                                        <small class="text-uppercase text-muted fw-bold" style="font-size: 0.7rem;">Bahan
                                            Utama</small>
                                ...
                                <div class="d-flex align-items-start p-3 rounded-3 bg-light border border-light h-100">
                                    ...
                                    <div>
                                        <small class="text-uppercase text-muted fw-bold"
                                            style="font-size: 0.7rem;">Kalori</small>
                                ...
                                <div class="row align-items-end">
                                    ...
                                    <div class="col-md-5 mb-3 mb-md-0">
                                        ...
                                        <div class="d-flex align-items-center bg-light rounded-pill px-2 py-1 border"
                                            ...
                                            <button type="button"
                                                class="btn btn-white rounded-circle shadow-sm p-0 d-flex align-items-center justify-content-center text-primary"
                                            ...
                                            <button type="button"
                                                class="btn btn-primary rounded-circle shadow-sm p-0 d-flex align-items-center justify-content-center text-white"
                                                style="width: 36px; height: 36px;" onclick="incrementValue()">
                                                <i class="fas fa-plus"></i>
                                            </button>
                                        </div>
                                        <div class="mt-2">
                                            <small class="text-muted"><i class="fas fa-box-open me-1"></i>Stok:
                                                {{ $menu->stok }}</small>
                                        </div>
                                    </div>
